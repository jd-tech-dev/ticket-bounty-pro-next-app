...
type OrganizationListProps = {
  limitedAcess?: boolean;
};

const OrganizationList = async ({ limitedAcess }: OrganizationListProps) => {
      ...
      <TableBody>
        {organizations.map((organization) => {
          ...
          const buttons = (
            <>
              {switchButton}
              {limitedAcess ? null : isAdmin ? detailButton : placeholder}
              {limitedAcess ? null : isAdmin ? editButton : placeholder}
              {limitedAcess ? null : leaveButton}
              {limitedAcess ? null : isAdmin ? deleteButton : placeholder}
            </>
          );
